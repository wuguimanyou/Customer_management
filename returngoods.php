...
<body data-ctrl=true>
	...
	<div class="white-list link-kefu">
		<div class="re_type" style="display:inline-block;height:50px;line-height:50px;margin-left:30px;">
	...
	<!-- 基本数据地区 - 开始 -->
		<div id="mainArea"> 
			...
			<input type="hidden" name="aftersale_type" value="returngoods">
			...
			<div class="itemComment" style="width:100%;" goodsId="1">
				<div class="white-list frame_reason" style="height:300px;">
					...
					<div class="frame_reason_textarea">
						<textarea name="re_describe" id="reasonContent" maxlength="125" placeholder="请填写您遇到的问题，最多125字。"></textarea>
					</div>
