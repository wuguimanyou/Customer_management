    ...
    <div class="WSY_data">
		...
		<form class="search" action="sale.php?customer_id=<?php echo $customer_id_en; ?>">
			...
			<div class="WSY_search_div">
				...
				<li id="li_sale">
                  <input type="checkbox" name="ordersale" id="ordersale" <?php echo $sales == 1 ? "checked" : "" ;?> style="width:auto;"/>
				...
				<tr id="WSY_q1">
					...
					<td>
						<div class="WSY_pricebox" style="display: inline-block;">
							...
							<li id="pronprice_<?php echo $p_id;?>" >￥<?php echo $p_now_price; ?></li>
						</div>
					...
					<td>
						...
						<img id="saveattrimg_<?php echo $p_id;?>" src="../../../common/images_V6.0/operating_icon/icon53.png" class=" ep_img pro_attrimg" style="padding:10px 0;" data-pro-id="<?php echo $p_id;?>" data-isout="<?php echo $p_isout;?>"data-ishot="<?php echo $p_ishot;?>" data-isnew="<?php echo $p_isnew;?>" data-isvp="<?php echo $p_isvp;?>">
					</td>
					<td>
					...
					<td class="WSY_t4" id="WSY_t4">
						...
						if($_SESSION['is_auth_user']=='no' or ($_SESSION['is_auth_user']=='yes' and $p_isout==1)){ // 如果是授权用户,则需要商家下架后才能编辑 或者 商家才能编辑?>
							<?php 
							if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2) or ($owner_general==0 and $create_type==3)) or ($create_type==-1) ){ ?>
								<a href="sale.php?customer_id=<?php echo $customer_id_en; ?>&keyid=<?php echo $p_id; ?>&op=del" onclick="if(!confirm(&#39;删除后不可恢复，继续吗？&#39;)){return false};" title="删除"><img src="../../../common/images_V6.0/operating_icon/icon04.png"></a>
							<?php 
							}
						}?>
						<a title="下架" href="sale.php?customer_id=<?php echo $customer_id_en; ?>&keyid=<?php echo $p_id; ?>&op=unsale" onclick="if(!confirm(&#39;是否确定将该商品下架？&#39;)){return false};"><img src="../../../common/images_V6.0/operating_icon/icon41.png"></a>
					</td>
				</tr>
				<?php } ?>
            </table>
